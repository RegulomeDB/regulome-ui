...
export const API_URL_GDS = "https://dev-d1c8912-demo-otto.demo.regulomedb.org";
export const API_CATALOG_BASE_URL = "https://api.catalogkg.igvf.org";
export const API_URL_VARIANT = API_CATALOG_BASE_URL + "/api/variants?";
export const API_URL_VARIANT_LD =
  API_CATALOG_BASE_URL + "/api/variants/variant-ld?";
export const API_URL_GDS_SCORE = API_URL_GDS + "/summary?";
export const API_URL_GENE =
  API_CATALOG_BASE_URL + "/api/variants/nearest-genes?";
export const API_URL_REGULATORY_REGION =
  API_CATALOG_BASE_URL + "/api/genomic-elements?";
