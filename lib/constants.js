...
export const API_URL_GDS = "https://gds-for-regulome-demo.demo.regulomedb.org";
export const API_URL_VARIANT = "https://api.catalog.igvf.org/api/variants?";
export const API_URL_VARIANT_LD =
  "https://api.catalog.igvf.org/api/variants/variant-ld?";
export const API_URL_GDS_SCORE =
  "https://gds-for-regulome-demo.demo.regulomedb.org/summary?";
export const API_URL_GENE =
  "https://api.catalog.igvf.org/api/variants/nearest-genes?";
export const API_URL_REGULATORY_REGION =
  "https://api.catalog.igvf.org/api/genomic-elements?";
