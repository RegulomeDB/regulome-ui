...
describe("Test the function sanitizedString", () => {
  it("sanitize string that contain upper case, space and symble &", () => {
    const str = "UPPER* &CASE";
    const sanitized = sanitizedString(str);
