...
export const GtexColor = {
  ...
  blood: { hex: "#FF00BB", priority: 2 },
  "blood vessel": { hex: "#FF0000", priority: 1.5 },
  "bodily fluid": { hex: "#FF00BB", priority: 4 },
  "bone element": { hex: "#C18D8D", priority: 4 },
  "bone marrow": { hex: "#C18D8D", priority: 1 },
  brain: { hex: "#EEEE00", priority: 1 },
  breast: { hex: "#33CCCC", priority: 1 },
  colon: { hex: "#CC9955", priority: 1 },
  "connective tissue": { hex: "#C18D8D", priority: 4 },
  ear: { hex: "#7FD976", priority: 3 },
  embryo: { hex: "#A809A8", priority: 3 },
  "endocrine gland": { hex: "#34A853", priority: 3 },
  epithelium: { hex: "#7777FF", priority: 2 },
  esophagus: { hex: "#552200", priority: 1 },
  "exocrine gland": { hex: "#BBE0C5", priority: 3 },
  "extraembryonic component": { hex: "#A809A8", priority: 1 },
  eye: { hex: "#A5d8A0", priority: 3 },
  gonad: { hex: "#7EEBF3", priority: 3 },
  heart: { hex: "#9900FF", priority: 2 },
  "immune organ": { hex: "#C27BA0", priority: 4 },
  intestine: { hex: "#555522", priority: 3 },
  kidney: { hex: "#22FFDD", priority: 1 },
  "large intestine": { hex: "#EEBB77", priority: 2 },
  limb: { hex: "#F4E17A", priority: 5 },
  liver: { hex: "#AABB66", priority: 1 },
  lung: { hex: "#99FF00", priority: 1 },
  "lymph node": { hex: "#C27BA0", priority: 3 },
  "lymphatic vessel": { hex: "#FF0000", priority: 4 },
  "lymphoid tissue": { hex: "#C27BA0", priority: 1 },
  "mammary gland": { hex: "#0F9E9E", priority: 1 },
  mouth: { hex: "#BAFD9D", priority: 1 },
  "musculature of body": { hex: "#F4E17A", priority: 3 },
  nerve: { hex: "#FFD700", priority: 1 },
  ovary: { hex: "#FFAAFF", priority: 1 },
  pancreas: { hex: "#995522", priority: 1 },
  penis: { hex: "#AAAAAA", priority: 5 },
  pericardium: { hex: "#7777FF", priority: 1 },
  "pituitary gland": { hex: "#EEEE00", priority: 2 },
  placenta: { hex: "#A809A8", priority: 1 },
  "prostate gland": { hex: "#DDDDDD", priority: 1 },
  skeleton: { hex: "#C18D8D", priority: 4 },
  "skin of body": { hex: "#7777FF", priority: 3 },
  "skin of prepuce of penis": { hex: "#0000FF", priority: 1 },
  "small intestine": { hex: "#555522", priority: 1 },
  "spinal cord": { hex: "#EEEE00", priority: 4 },
  spleen: { hex: "#778855", priority: 2 },
  stomach: { hex: "#FFDD99", priority: 1 },
  testis: { hex: "#AAAAAA", priority: 1 },
  thymus: { hex: "#C27BA0", priority: 2 },
  "thyroid gland": { hex: "#006600", priority: 1 },
  ureter: { hex: "#22FFDD", priority: 2 },
  "urinary bladder": { hex: "#22FFDD", priority: 1 },
  uterus: { hex: "#FF66FF", priority: 1 },
  vagina: { hex: "#FF5599", priority: 1 },
  vasculature: { hex: "#FF0000", priority: 4 },
  vein: { hex: "#FF0000", priority: 2 },
};
