...
const GENOMIC_ELEMENT_SOURCE = "ENCODE";
const GENOMIC_ELEMENT_METHOD = "candidate Cis-Regulatory Elements";
...
async function getRegulatoryRegions(request, region) {
  ...
  let total = [];
  do {
    const query = `${API_URL_REGULATORY_REGION}organism=Homo%20sapiens&source=${GENOMIC_ELEMENT_SOURCE}&method=${GENOMIC_ELEMENT_METHOD}&region=${region}&page=${pageNum}&limit=1000`;
